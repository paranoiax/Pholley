...
function love.update(dt)
	...
	if begin_player_1 == true then
		objects.ball.body:applyLinearImpulse(44, 0)
...
function player2_ai()
	if objects.ball.body:getX() > screenWidth / 2 and objects.ball.body:getX() +20 < objects.player2.body:getX() then
		objects.player2.body:applyForce(-1900, 0)
	...
	if objects.ball.body:getX() > screenWidth / 2 and objects.ball.body:getY() > screenHeight - screenHeight / 3 and objects.player2.body:getY() > objects.ball.body:getY() and objects.ball.body:getX() - 35 < objects.player2.body:getX() and objects.ball.body:getX() + 35 > objects.player2.body:getX() then
		objects.player2.body:applyLinearImpulse(0, -185)
	elseif objects.ball.body:getX() < screenWidth / 2 - 40 and objects.player2.body:getX() < screenWidth / 4 * 3 - 50 then
		objects.player2.body:applyForce(1800, 0)
	elseif objects.ball.body:getX() < screenWidth / 2 - 40 and objects.player2.body:getX() > screenWidth / 4 * 3 + 50 then
		objects.player2.body:applyForce(-1800, 0)
	end
end
...
function controls()
	function love.keypressed(key)
		if objects.player1.body:getY() > screenHeight - 55 and key == "w" then
			objects.player1.body:applyLinearImpulse(0, -1250)
		elseif objects.player1.canJumpAgain == 1 and key == "w" then
			objects.player1.body:applyLinearImpulse(0, -900)
			objects.player1.canJumpAgain = 0
	...
	if love.keyboard.isDown("a") then
		objects.player1.body:applyForce(-3200, 0)
